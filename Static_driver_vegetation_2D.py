...
from util.PALM.canopy_generator import generate_single_tree_lad, process_patch 
...
def generate_palm_static_LAD(case_name, tmp_path, idomain, config_proj, dom_dict):
    ...
    lad_patch, patch_id,patch_types, patch_nz,status = process_patch(dz, vegetation_height, vegetation_type, vegetation_type, np.max(vegetation_height), LAI, 5.0, 3.0)
